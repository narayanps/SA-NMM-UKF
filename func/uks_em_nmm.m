function [x_hat_f,P_xx_f,x_hat_s,P_xx_s,Q_hist, loglikes]=uks_em_nmm(ukf_params,f,h,x_hat0,P_xx0, y, H, Q, R, p)
...
%           end
        ...
        [x_hat, y_hat, P_xx, P_yy, P_xy, E_x1] = ukf_time_upd(f, h, W_mean, W_cov, X, n, m, k ,H, Q, R, p(t));
...
function [x, y, Pxx, Pyy, Pxy, Ex] = ukf_time_upd(f, h, W_mean, W_cov, X, n, m, k, H, Q, R, p)
x=zeros(n,1);
y=zeros(k,1);
X1=zeros(n,m);
Eta1=zeros(k,m);
